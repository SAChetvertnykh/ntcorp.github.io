...
<head>
    ...
    <script>
      (function () {
        try {
          var savedTheme = localStorage.getItem('navitech-theme');
          if (savedTheme === 'light' || savedTheme === 'dark') {
            document.documentElement.setAttribute('data-theme', savedTheme);
          }
        } catch (e) {
          /* localStorage недоступен (приватный режим и т.п.) — используем тему по умолчанию */
        }
      })();
    </script>
</head>
    ...
    <header id="site-header" class="site-header">
        <div class="header-container">
            ...
            <div class="header-actions">
                ...
                <a href="#contacts" class="btn btn-contact" id="header-contact-btn">Связаться</a>
            ...
            <div class="services-list">
                <article class="service-card" id="service-crm">
                    <div class="service-icon">
                        <img src="img/CRM%20img.webp" alt="Иконка разработки CRM-систем">
                    </div>
                ...
                <article class="service-card" id="service-web">
                    <div class="service-icon">
                        <img src="img/web.0.2.webp" alt="Иконка веб-разработки">
                    </div>
                ...
                <article class="service-card" id="service-automation">
                    <div class="service-icon">
                        <img src="img/avto.jpg" alt="Иконка автоматизации бизнес-процессов">
                    </div>
                ...
                <article class="service-card" id="service-support">
                    <div class="service-icon">
                        <img src="img/technical-support-icon-blac-silhouette-vector.jpg" alt="Иконка технической поддержки">
                    </div>
            ...
            <div class="product-gallery" id="product-gallery">
                <div class="product-gallery-track" id="product-gallery-track">
                    <figure class="product-gallery-slide">
                        <img src="img/CRM%20photo1.png" alt="Скриншот интерфейса CRM-системы UBP — дашборд с ключевыми показателями">
                    </figure>
                    <figure class="product-gallery-slide">
                        <img src="img/CRM%20photo2.png" alt="Скриншот интерфейса CRM-системы UBP — воронка продаж">
                    </figure>
                    <figure class="product-gallery-slide">
                        <img src="img/CRM%20photo3.png" alt="Скриншот интерфейса CRM-системы UBP — карточка клиента">
                    </figure>
                    <figure class="product-gallery-slide">
                        <img src="img/CRM%20photo4.png" alt="Скриншот интерфейса CRM-системы UBP — аналитика и отчеты">
                    </figure>
                    <figure class="product-gallery-slide">
                        <img src="img/CRM%20photo5.png" alt="Скриншот интерфейса CRM-системы UBP — мобильное приложение">
                    </figure>
                </div>
                <button type="button" class="product-gallery-edge product-gallery-edge--prev" id="product-gallery-prev" aria-label="Предыдущий слайд"></button>
                <button type="button" class="product-gallery-edge product-gallery-edge--next" id="product-gallery-next" aria-label="Следующий слайд"></button>
                <div class="product-gallery-dots" id="product-gallery-dots">
                    <button type="button" class="product-gallery-dot is-active" data-slide-index="0" aria-label="Показать слайд 1"></button>
                    <button type="button" class="product-gallery-dot" data-slide-index="1" aria-label="Показать слайд 2"></button>
                    <button type="button" class="product-gallery-dot" data-slide-index="2" aria-label="Показать слайд 3"></button>
                    <button type="button" class="product-gallery-dot" data-slide-index="3" aria-label="Показать слайд 4"></button>
                    <button type="button" class="product-gallery-dot" data-slide-index="4" aria-label="Показать слайд 5"></button>
                </div>
            </div>
        ...
        <div class="partners-container">
            ...
            <div class="partners-logos">
                <div class="partner-logo">
                    <img src="img/Полиэкс.png" alt="Логотип партнера компании номер один">
                </div>
                <div class="partner-logo">
                    <img src="img/ООО%20БИГ-Ассистент.png" alt="Логотип партнера компании номер два">
                </div>
                <div class="partner-logo">
                    <img src="img/Право%20собственности.png" alt="Логотип партнера компании номер три">
                </div>
                <div class="partner-logo">
                    <img src="img/Федеральная%20недвижимость.png" alt="Логотип партнера компании номер четыре">
                </div>
            </div>
